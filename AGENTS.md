...
- Database setup is in `db/`, SQLAlchemy models/schemas in `models/`, and CRUD helpers in `crud/`.
- The adaptive sampling algorithm lives in `algorithm_to_find_combinations/`.
